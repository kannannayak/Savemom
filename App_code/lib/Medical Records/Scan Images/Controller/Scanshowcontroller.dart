...
class Scanshowcontroller extends GetxController {
  ...
  Future<void> scanreportapi() async {
    ...
    var apiUrl = ApiendPoints.maniurl + ApiendPoints.scanmedicalapi;
  ...
  Future<void> deletescan(String reportId) async {
    ...
    try {
      ...
      if (responseData.statusCode == 200) {
        final scandelete = Scanfiledeletemodel.fromJson(
