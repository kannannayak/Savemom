...
import 'package:savemom/Medical%20Records/Lab/Controller/labshowcontroller.dart';
...
class _LabReportsState extends State<LabReports> {
  final scanlistdata = Get.put(Labshowcontroller());

  final scandeletehit = Get.put(Labshowcontroller());

  final labdatecontroller = Get.put(Medicalcontroller());
  ...
  Future<void> _selectDate(
    ...
    if (pickedDate != null) {
      ...
      setState(() {
        ...
        labdatecontroller.labdate.value = formattedDate;
        print(labdatecontroller.labdate.value.toString());
      });
    }
  }
                  ...
                  ElevatedButton(
                    ...
                    onPressed: () {
                      ...
                      if (ddmmyyyy.text.isEmpty) {
                        ...
                        Get.to(LabImages(), transition: Transition.fade);
                      }
                    },
                    child: Text(
                      "Submit".tr,
                              ...
                              child: Row(
                                ...
                                children: [
                                  ...
                                  InkWell(
                                    ...
                                    child:
                                        Image.asset("assets/images/Foldr.png"),
                                  ),
                                  swbox10,
                                  InkWell(
                                    onTap: () {
