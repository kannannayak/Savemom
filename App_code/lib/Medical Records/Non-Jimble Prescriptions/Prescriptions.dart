...
import 'package:savemom/Medical%20Records/Non-Jimble%20Prescriptions/Controller/Prescriptioncontroller.dart';


import '../../language.dart';
import '../View_Folder.dart';
import 'Prescriptions_Images.dart';

class PrescriptionsReports extends StatefulWidget {
  const PrescriptionsReports({Key? key}) : super(key: key);

  @override
  State<PrescriptionsReports> createState() => _PrescriptionsReportsState();
}

class _PrescriptionsReportsState extends State<PrescriptionsReports> {
  final scandeletehit = Get.put(Prescriptioncontroller());
  final scanlistdata = Get.put(Prescriptioncontroller());
  final predatecontroller = Get.put(Medicalcontroller());
  ...
  Future<void> _selectDate(
    ...
    if (pickedDate != null) {
      ...
      setState(() {
        ...
        predatecontroller.predate.value = formattedDate;
        print(predatecontroller.predate.value.toString());
      });
    }
  }
            ...
            Obx(() {
              ...
              final seenFileIds = <int>{};
                ...
                DateTime? fromDate = Labfrom.text.isNotEmpty
                    ...
                    : null;
                DateTime? toDate = LabTo.text.isNotEmpty
                    ? DateTime.tryParse(LabTo.text)
                    : null;
                                ...
                                InkWell(
                                  ...
                                  onTap: () {
                                    if (file.fileUrl != null &&
                                      ...
                                      Get.to(
                                        () => ViewFolder(
                                          title: "View PrescriptionReports",
