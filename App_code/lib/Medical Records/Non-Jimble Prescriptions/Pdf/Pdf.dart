...
import 'package:savemom/Medical%20Records/Non-Jimble%20Prescriptions/Pdf/pdfpreviwe.dart';




class PerPdf extends StatefulWidget {
  @override
  _PerPdfState createState() => _PerPdfState();
}

class _PerPdfState extends State<PerPdf> {
                        ...
                        InkWell(
                          onTap: () {
                            if (selectedFiles.isNotEmpty) {
                              Get.to(PrePdfpreviwe(), arguments: selectedFiles);
                              Get.snackbar(
                                "",
                                "",
                                messageText: Text(
