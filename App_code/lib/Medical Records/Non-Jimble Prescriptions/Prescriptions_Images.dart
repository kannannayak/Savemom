...
class PrescriptionsImages extends StatefulWidget {
  const PrescriptionsImages({Key? key}) : super(key: key);

  @override
  State<PrescriptionsImages> createState() => _PrescriptionsImagesState();
}

class _PrescriptionsImagesState extends State<PrescriptionsImages> {
  File? _selectedImage;
