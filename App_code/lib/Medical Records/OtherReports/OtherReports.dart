...
import 'package:savemom/Medical%20Records/OtherReports/Controller/Othercontroller.dart';


import '../../language.dart';
import '../View_Folder.dart';
import 'OtherReports_Images.dart';

class OtherReports extends StatefulWidget {
  const OtherReports({Key? key}) : super(key: key);

  @override
  State<OtherReports> createState() => _OtherReportsState();
}

class _OtherReportsState extends State<OtherReports> {
  final scanlistdata = Get.put(Othercontroller());

  final scandeletehit = Get.put(Othercontroller());
  final othdatecontroller = Get.put(Medicalcontroller());
  ...
  Future<void> _selectDate(
    ...
    if (pickedDate != null) {
      ...
      setState(() {
        ...
        othdatecontroller.othdate.value = formattedDate;
        print(othdatecontroller.othdate.value.toString());
      });
    }
  }
