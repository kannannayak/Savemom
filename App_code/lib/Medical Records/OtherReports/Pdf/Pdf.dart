...
import 'package:savemom/Medical%20Records/OtherReports/Pdf/pdfpreviwe.dart';



class OthPdf extends StatefulWidget {
  @override
  _OthPdfState createState() => _OthPdfState();
}

class _OthPdfState extends State<OthPdf> {
                        ...
                        InkWell(
                          onTap: () {
                            if (selectedFiles.isNotEmpty) {
                              Get.to(OthPdfpreviwe(), arguments: selectedFiles);
                              Get.snackbar(
                                "",
                                "",
                                messageText: Text(
