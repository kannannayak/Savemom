...
// import 'package:jimbel_patent/Medical%20Records/OtherReports/OtherReports.dart';
// import 'package:jimbel_patent/language.dart';

// class OthImageview extends StatefulWidget {
//   const OthImageview({super.key});

//   @override
//   State<OthImageview> createState() => _OthImageviewState();
// }

// class _OthImageviewState extends State<OthImageview> {
...
//           // Add this variable at your widget's state level
...
//                 try {
//                   bool returnValue = await pic.Medicalrecordsapi(
//                     pic.othdate.toString(),
//                     scanImage,
//                     scanGallery,
//                     scanPdf,
