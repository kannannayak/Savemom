...
import 'package:savemom/Medical%20Records/DischargeSummary/Controller/dischargecontroller.dart';
...
import 'DischargeSummary_Images.dart';

class DischargeSummary extends StatefulWidget {
  const DischargeSummary({Key? key}) : super(key: key);
...
class _DischargeSummaryState extends State<DischargeSummary> {
  final scanlistdata = Get.put(Dischargecontroller());
  final scandeletehit = Get.put(Dischargecontroller());
  final ddmmyyyycontroller = Get.put(Medicalcontroller());
  ...
  Future<void> _selectDate(
    ...
    if (pickedDate != null) {
      ...
      setState(() {
        ...
        ddmmyyyycontroller.date.value = formattedDate;
        print(ddmmyyyycontroller.date.value.toString());
      });
    }
  }
