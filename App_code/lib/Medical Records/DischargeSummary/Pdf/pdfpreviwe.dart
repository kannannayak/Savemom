...
import 'package:savemom/Medical%20Records/DischargeSummary/DischargeSummary.dart';
import 'package:savemom/Medical%20Records/MedicalController.dart';
import 'package:savemom/language.dart';

class Pdfpreviwe extends StatefulWidget {
  const Pdfpreviwe({super.key});

  @override
  State<Pdfpreviwe> createState() => _PdfpreviweState();
}

class _PdfpreviweState extends State<Pdfpreviwe> {
