// ignore_for_file: unused_local_variable, use_super_parameters, unused_import, file_names, non_constant_identifier_names, unused_element, unused_field, avoid_print
...
class DischargeSummaryImages extends StatefulWidget {
  const DischargeSummaryImages({Key? key}) : super(key: key);

  @override
  State<DischargeSummaryImages> createState() => _DischargeSummaryImagesState();
}

class _DischargeSummaryImagesState extends State<DischargeSummaryImages> {
  ...
  Future<void> scanDocument() async {
    try {
      ...
      if (result != null && result['pdfUri'] != null) {
        ...
        final bool value = await pic.Medicalrecordsapi(medicalcords.date.value,
            "", [], [], "", [], [], "", [], [], pdfUri, [], [], "", [], []);
        Get.back();
        if (value == true) {
